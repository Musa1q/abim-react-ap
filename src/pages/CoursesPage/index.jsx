...
import { FaCalendar, FaClock, FaArrowRight, FaGift, FaSpinner } from 'react-icons/fa';
      ...
      <div className="min-h-screen bg-gray-50">
        <div className="container mx-auto px-4 py-16">
          ...
          {isLoading ? (
            ...
            <div className="text-center p-8">
              <div className="text-gray-500 mb-4">Henüz kurs bulunmuyor.</div>
            </div>
          ) : (
                ...
                <div className="p-6">
                  ...
                  <div className="space-y-3 mb-6">
                    <div className="flex items-center text-gray-600">
                      ...
                      <span>Başlangıç: {new Date(course.content.egitimSuresi[0]["Başlangıç"]).toLocaleDateString('tr-TR', {
                        year: 'numeric',
                        month: 'short',
                        day: 'numeric'
                      })}</span>
                    ...
                    <div className="flex items-center text-gray-600">
                      ...
                      <span>{course.dersGunleri.join(', ')} - {course.dersSaati}</span>
                    </div>
                  </div>
