...
import { FaCalendar, FaClock, FaList, FaArrowLeft, FaUsers, FaChalkboardTeacher, FaGift, FaSpinner } from 'react-icons/fa';
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-50">
        <div className="text-center bg-white p-8 rounded-lg shadow-lg">
          ...
          <h2 className="text-2xl font-bold mb-4">Kurs Yükleniyor...</h2>
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-50">
        <div className="text-center bg-white p-8 rounded-lg shadow-lg">
          ...
          <p className="text-gray-600 mb-6">{error || 'Aradığınız kurs bulunamadı.'}</p>
              ...
              <div className="p-4 bg-gray-50 rounded-lg">
                <div className="text-center mb-3">
                  <div className="text-2xl font-bold text-blue-500 mb-2">
                    {course.dersGunleri.join(', ')}
                  </div>
                  <div className="text-gray-500">
                    Saat: {course.dersSaati}
                  </div>
                </div>
